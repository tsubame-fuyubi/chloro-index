//! Legacy CLI demo for ChloroDB genomic sequence index (v1.1.0-simd).
//!
//! This binary preserves the original interactive shell interface for
//! importing FASTA files and querying genomic k-mer locations.
//! Run with: cargo run --bin demo_v1_simd
